...
function M.parse(arg)
   ...
   cmd:option('-dataset',    'laneE', 'Options: imagenet | cifar10 | cifar100 | lane | honda | laneE')
   ...
   cmd:option('-labelType',       'seg',   'the type of labels')
   cmd:option('-nLane',       6,   'number of lanes')
   ...
   elseif opt.dataset == 'cifar100' then
       ...
       opt.shortcutType = opt.shortcutType == '' and 'A' or opt.shortcutType
       opt.nEpochs = opt.nEpochs == 0 and 164 or opt.nEpochs
   elseif opt.dataset == 'lane' or opt.dataset == 'laneTest' or opt.dataset == 'laneE' then
      opt.nEpochs = opt.nEpochs == 0 and 90 or opt.nEpochs
   else
